...
def update():
	...
	print("\t\t 2 - Nodes ground-auto selection firmware")
...
def advanced():
	...
	def bootloader(): 
		print("\n\t\t\t BOOTLOADER MENU")
		print("\n\t\t 1 - Flash the bootloader on node 1")
		print("\n\t\t 2 - Flash the bootloader on node 2")
		print("\n\t\t 3 - Flash the bootloader on node 3")
		print("\n\t\t 4 - Flash the bootloader on node 4")
		print("\n\t\t 5 - Go back")
	...
	def avr_info():
		...
		if selection=='3' : 
			...
			os.system("rm /root/pi/.avrduderc")
			...
			os.system("echo ' type  = \"linuxgpio\";| sudo  tee -a /root/pi/.avrduderc")
	...
	def program_node():
		def nodeMenu():
			...
			if selection=='1':
				...
				print("\t\t 2 - Node ground-auto selectionfirmware")
...
def first():
	...
	print("\n\t\t that you won't be able to connec your Arduinos to the usb port and using it with PC anymore,")
	print("\n\t\t unless you flash bootloader back using 'Advanced menu' of this software.")
	print("\n\n ")
	print("\n\t\t It is recommended to flash nodes with specfic file for every node, even if you are using auto selection mod.")
