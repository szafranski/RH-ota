...
if not os.path.exists(homedir+"/.ota_markers/.installation-check_file.txt"):
    os.system(f"cp {homedir}/.old_RotorHazard.old/.installation-check_file.txt \
{homedir}/.ota_markers/.installation-check_file.txt > /dev/null 2>&1")
...
{homedir}/RH-ota/updater-config.json")
