...
for i in range (3):
    ...
    if os.path.exists(homedir+"/.aliases_added"):
    ...
    if os.path.exists(homedir+"/.serialok"):
        if not os.path.exists(homedir+"/.ota_markers/.serialok"):
            os.system("cp "+homedir+"/.serialok "+homedir+"/.ota_markers/.serialok")
        os.system("rm "+homedir+"/.serialok")
    if os.path.exists(homedir+"/.bashrc"):
